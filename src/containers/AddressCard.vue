...
<script>
import DisplayCard from "@/components/AddressCard/DisplayCard.vue";
import DisplayFooter from "@/components/AddressCard/DisplayFooter.vue";
import EditCard from "@/components/AddressCard/EditCard.vue";
import EditFooter from "@/components/AddressCard/EditFooter.vue";
